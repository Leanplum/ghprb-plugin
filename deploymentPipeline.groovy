        ...
        script {
          dir("target") {
            ...
            withCredentials([usernameColonPassword(credentialsId: 'ppeshevToken', variable: 'USERPASS')]) { 
              def CRUMB = sh (script: """curl -s 'https://petar.peshev@leanplum.com:11eacc27f54406da0b933adc6c20cee7e4@jenkins-staging.leanplum.com/crumbIssuer/api/xml'""",returnStdout: true)
              echo "$CRUMB"
