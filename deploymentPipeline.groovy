      ...
      steps {
        script {
          dir("target") {
            ...
            script {
            sh """curl -i -u 'petar.peshev@leanplum.com:11eacc27f54406da0b933adc6c20cee7e4' 'https://${env.JENKINS_URL}/crumbIssuer/api/xml?xpath=concat(//crumbRequestField,":",//crumb)'"""
