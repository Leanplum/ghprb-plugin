      ...
      steps {
        script {
          dir("target") {
            ...
            script {
            sh """curl --request GET --url 'https://jenkins-staging.leanplum.com/crumbIssuer/api/xml?xpath=concat(//crumbRequestField,":",//crumb)'  -u "petar.peshev@leanplum.com":'11eacc27f54406da0b933adc6c20cee7e4'"""
